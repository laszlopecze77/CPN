...
#'
#' This method extracts residuals from a fitted model object of class \code{"cpn"}.
...
#'
#' @return A numeric vector of residuals. Returns deviance residuals if \code{type = "deviance"},
