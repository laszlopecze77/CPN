...
#'
#' @return A variance-covariance matrix of the model parameters. Rows and columns are named
...
#'
#' @seealso \code{\link{cpn}}, \code{\link{summary.cpn}}, \code{\link[numDeriv]{hessian}}
#'
#' @examples
#' set.seed(123)
